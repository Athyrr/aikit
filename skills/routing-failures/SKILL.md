...
description: Use when a task fails, stalls, or surprises you - decides whether to go down (probe, fix rounds) or up (re-plan, re-spec), enforces the attempt budget, and defines what an escalation must contain
---
